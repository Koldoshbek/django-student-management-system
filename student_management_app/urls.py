...
urlpatterns = [
    ...
    path('manage_survey/', HodViews.manage_survey, name="manage_survey"),
    path('edit_survey/<survey_id>/', HodViews.edit_survey, name="edit_survey"),
    path('edit_survey_save/', HodViews.edit_survey_save, name="edit_survey_save"),
